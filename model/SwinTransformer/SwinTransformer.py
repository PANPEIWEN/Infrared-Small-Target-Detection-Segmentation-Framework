...
class PPM(nn.Module):
    def __init__(self, num_class=3, fc_dim=768,
...
def Swin():
    ...
    weight = \
        torch.load(
            "/data/panpw/works/Infrared/All_ISTD/model/SwinTransformer/pretrained/swin_base_patch4_window7_224_22k.pth",
...
class Swin_Uper(nn.Module):
    def __init__(self):
        ...
        self.decode = SwinTransformer()
        self.head = UPerNet(num_class=1, fc_dim=1024, fpn_inplanes=(128, 256, 512, 1024))
