...
from model.ACM.fusion import AsymBiChaFuseReduce, BiLocalChaFuseReduce, BiGlobalChaFuseReduce
...
class ASKCResNetFPN(nn.Module):
    def __init__(self, layer_blocks, channels, fuse_mode='AsymBi', **kwargs):
...
if __name__ == '__main__':
    ...
    model = ASKCResNetFPN([4, 4, 4], [8, 16, 32, 64])
    out = model(x)
    print(out.size())
